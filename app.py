...
st.markdown("Ask anything about a GitHub repository, and the AI will fetch and process relevant GitHub data.")
...
if repo_url:
    ...
    if api_url:
        ...
        st.error("❌ Invalid GitHub repository URL. Please enter a valid repo URL (e.g., `https://github.com/owner/repo`).")
else:
